...
export default async function handler(req, res){
  ...
  try{
    ...
    // Sunize pode enviar payload em diferentes formatos; normaliza
    ...
    // esperado: userId|plan|timestamp
    ...
    // Sem Supabase: apenas reconhece webhook
    ...
    if(isPaid){
      ...
      if(!r.ok){
        // Variante B (active/plan_id + start_at/end_at)
    ...
    if(isFailed){
      // desativa assinatura atual do usuário
      // localiza a mais recente ativa
