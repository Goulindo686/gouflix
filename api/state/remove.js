export default async function handler(req, res) {
  ...
  try {
    ...
    // Atualiza estado: remove item dos adicionados e adiciona chave aos removidos
    ...
    return res.status(500).json({ error: err.message || 'Erro interno em /api/state/remove' });
  }
}
